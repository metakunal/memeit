        ...
        return (
            <div>
                <div className="main-content">
                    <div className="sidebar" style={{ backgroundColor: "#3F3351" }}>
                        <NavbarBrand href="/">Meme-Snap</NavbarBrand>
                        <p>
                            A fun react tool to help you make memes on the go.
                        </p>
                        <p>
                            You can add top and bottom text to a meme-template, move the text around and can save the image by downloading it.
                        </p>
                    </div>
                    <div className="content" style={{ backgroundColor: "#1F1D36" }} >
                ...
                <Modal className="meme-gen-modal" isOpen={this.state.modalIsOpen}>
                    <ModalHeader toggle={this.toggle}>Memestudio ✏</ModalHeader>
                    <ModalBody>
                        <svg
                            width="600"
                            id="svg_ref"
                        ...
                        <div className="meme-form">
                            ...
                            <button onClick={() => this.convertSvgToImage()} className="btn btn-primary" style={{ marginTop: "10px" }}>Post</button>
                        </div>
                    </ModalBody>
                </Modal>
            </div >
